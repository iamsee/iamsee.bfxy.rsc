...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			boolean blcreatedoc = (boolean)session.getAttribute("blcreatedoc");
			String backmsgcreatedoc  = (String)session.getAttribute("backmsgcreatedoc");
			System.out.println(blcreatedoc);
			if (blcreatedoc == true)
			{
			%>
			<script type="text/javascript"> alert("<%=backmsgcreatedoc%>"); </script>
			<%}
...
<body>
	<div class="pager_center_right">
		<div class="bigbody">
			<form action="servlet/createdocaction" method="post" id="myform">
				类别： <select id="condition" name="condition" style="width: 200px;">
					<%if(menulist ==null||menulist.size()==0) {%> option
					value="">没有获取到menulist
					</option>
					<%}else{
		...
		%>
				...
				</select> <br /> 标题： <input type="text" name="title"  style="width: 200px; "/> <br />

				<textarea name="content" id="content"
					style="width: auto;height: 600px">这里写你的初始化内容</textarea>
