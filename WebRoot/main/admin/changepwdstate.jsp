...
boolean blchangepwd  = (boolean)session.getAttribute("blchangepwd");
String backmsgchangpwd = (String)session.getAttribute("backmsgchangepwd");

%>
<script type="text/javascript"> alert("<%=backmsgchangpwd%>"); </script>
<%
...
<html>
  <head>
    ...
    <title>My JSP 'changepwdstate.jsp' starting page</title>
